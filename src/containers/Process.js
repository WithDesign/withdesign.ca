    ...
    return (
      <div className={`solutions ${className}`}>
        ...
        <div className="page-intro process-header">
          <div className="container">
            <h1 className="text-center text-upper text-white weight-700 no-mar-bottom">
              Solving your business problems <br />
              <span className="weight-300 text-lower h3">
        ...
        <div className="no-mar-top no-pad-top content-wrapper pad-30-right pad-30-left mar-30-bottom">
          <div className="row center-sm pad-30-bottom mar-30-bottom mar-30-top">
          ...
          <div className="text-container container">
            <div className="row no-margin mar-15-top solution-section">
              <div className="col-xs-12 col-sm-8">
                ...
                <span>
                  <i className="fa fa-check" /> A/B testing <br />
                  <i className="fa fa-check" /> User & customer testing <br />
                  <i className="fa fa-check" /> Many other research and testing
                  methods.
                  <br />
                  <br />
          ...
          <div className="container">
            <div className="row solution-col-section">
              <div className="col-xs-12 col-sm-3">
                <h4>Strategize.</h4>
                <p>
                  <b>
                    We will work with you directly to create a strategy that
                    fits perfectly within your business using our rigorous,
                    highly tested process.
                  </b>{" "}
                  This could be anything from how to grow your Shopify store,
                  optimizing your brand, building out a new product idea and so
                  much more.
                </p>
              </div>
              <div className="col-xs-12 col-sm-3">
                ...
                <p>
                  ...
                  This could be anything from funnel’s, store development,
                  building eCommerce infrastructure and setup on any CMS, CRM or
                  any other platform. We will also commit to any brand
                  development, marketing assets, UI/UX mockups, flows and
                  research.
                </p>
              </div>
              <div className="col-xs-12 col-sm-3">
              ...
              <div className="col-xs-12 col-sm-3">
                ...
                <p>
                  <b>
                    We specialize in page and funnel optimization for
                    conversions or any other metric goal.
                  </b>{" "}
                  Data is used to analyze and help us make decisions on all type
                  of traffic sources from organic to directed to paid traffic.
                </p>
              </div>
            </div>
            <div className="row no-margin solution-section">
            ...
            <div className="text-center mar-30-bottom pad-30-bottom">
              <Link
                className="btn btn-cta-1 pad-15 mar-15-top mar-15-bottom text-center center"
                to="/start"
                title="Start a conversation today!"
