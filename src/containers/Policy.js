      ...
      >
        <div className="iub_content legal_pp">
          ...
          <div className="one_line_col">
            ...
            <p>Among the types of Personal Data that this Application collects, by itself or through third parties, there are: Cookies, email address and company name.</p>
          ...
          <div className="one_line_col">
            ...
            <p>The Data concerning the User is collected to allow the Owner to provide its services, as well as for the following purposes: Traffic optimization and distribution, Contacting the User and Managing contacts and sending messages.</p>
            ...
            <ul className="for_boxes">
              <li>
                <div className="box_primary box_10 expand expanded">
                  <h3 className="expand-click w_icon_24 policyicon_purpose_4222186">Contacting the User</h3>
                  <div className="expand-content">
                    ...
                    <p>Personal Data collected: company name and email address.</p>
                  </div>
                </div>
              </li>
              <li>
                <div className="box_primary box_10 expand expanded">
                  <h3 className="expand-click w_icon_24 policyicon_purpose_4222187">Managing contacts and sending messages</h3>
                  <div className="expand-content" >
                    ...
                    <p>Place of processing: US – <a href="https://www.constantcontact.com/legal/privacy-statement" target="_blank">Privacy Policy</a></p>
              ...
              <li>
                <div className="box_primary box_10 expand expanded">
                  <h3 className="expand-click w_icon_24 policyicon_purpose_4222185">Traffic optimization and distribution</h3>
                  <div className="expand-content">
                    ...
                    Considering the widespread distribution of this system, it is difficult to determine the locations to which the contents that may contain Personal Information User are transferred.</p>
          ...
          <div className="one_line_col">
            <div className="box_primary box_10 definitions expand expanded">
              <h3 className="expand-click w_icon_24 icon_ribbon">Definitions and legal references</h3>
              <div className="expand-content">
